  ...
  return (
    <div className="mx-auto max-w-6xl space-y-10 px-4 py-14 sm:px-6 lg:px-8">
      <section className="max-w-2xl">
        <p className="text-sm font-bold text-[#0E5F67]">Page not found</p>
        ...
        <Link
          href="/"
          className="mt-6 inline-flex rounded-md bg-[#0E5F67] px-5 py-3 font-semibold text-white hover:bg-[#0A3F49] focus:outline-none focus:ring-2 focus:ring-[#0E5F67] focus:ring-offset-4"
        >
          Go to homepage
        </Link>
      </section>
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-bold text-[#0B2F35]">Popular calculators</h2>
