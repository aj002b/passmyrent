...
export function Footer() {
  return (
    <footer className="border-t border-[#16423D] bg-[#0F2E2B] text-white">
      <div className="site-container grid gap-8 py-10 md:grid-cols-[1fr_auto]">
        <div>
          ...
          <p className="mt-3 max-w-2xl text-sm leading-6 text-[#D6E7E1]">
        ...
        <div className="flex flex-wrap gap-3 text-sm font-bold text-[#D6E7E1] md:justify-end">
        ...
        <p className="text-sm text-[#D6E7E1]/80 md:col-span-2">
